# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-01-15 12:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dating_sex', models.CharField(choices=[('male', '男性'), ('famale', '女性')], max_length=8, verbose_name='匹配的性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('male', '男性'), ('famale', '女性')], max_length=8, verbose_name='性别')),
                ('birth_year', models.IntegerField(default=2000, verbose_name='出生年')),
                ('birth_month', models.IntegerField(default=1, verbose_name='出生月')),
                ('birth_day', models.IntegerField(default=1, verbose_name='出生日')),
                ('avatar', models.ImageField(max_length=256, upload_to='', verbose_name='个人形象的URL')),
